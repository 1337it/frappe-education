       ...
       // Add a listener to get smartphone orientation 
           // in the alpha-beta-gamma axes (units in degrees)
		    ...
		    var sidetoside_degrees = event.gamma;
                ...
                dot.attributes.style.value = "height: 100%; width: 100%;-webkit-mask:url(/files/main1.png) no-repeat 50% 50%;background-image:url(/files/main2.png);mask:url(/files/main1.png) no-repeat 50% 50%;-webkit-mask-size:contain;mask-size:contain;background-size:165px 250px;background-repeat:no-repeat;background-position:"+ sidetoside_degrees + "% "+ frontToBack_degrees + "%;";
