...
<div id="map"></div>
<iframe id="item" width="100%" height="100%" frameborder="0" style="border: 1px solid white;width: 90vw;left: 5vw;position: fixed;top: 5vw;height: 66vh;box-shadow: #00000026 0 5px 15px;" referrerpolicy="no-referrer-when-downgrade" src allowfullscreen></iframe>
		</div>
